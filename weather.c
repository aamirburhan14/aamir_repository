...
weather* find(const weather*,int,int);          //find record by city code
weather* findc(const weather*,int,char *);      //find record by  city name
int main()
{
...
weather* find(const weather *f1,int n,int cc)
{
    const weather *pc=f1;
    for(int i=0;i<n;i++)
    {
...
weather* findc(const weather *f2,int n,char* cc)
{
    const weather *pc=f2;
    for(int i=0;i<n;i++)
    {
